...
{
    public partial class VistaPreviaEyS : SuperVistaPrevia
    {
        public VistaPreviaEyS()
        {
            InitializeComponent();
        }

        private void VistaPreviaEyS_Load(object sender, EventArgs e)
        {
            ReporteCompras rs = new ReporteCompras();
