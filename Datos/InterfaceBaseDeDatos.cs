...
namespace Datos
{
    public partial class InterfaceBaseDeDatos
    {
        ...
        public int RegistrarDatosFactura(string[] Datos)
        {
            ...
            return Ejecutar("procRegistrarDatosFactura", Parametros, Datos[0], Datos[1], Datos[2], Datos[3], Datos[4], Datos[5], Datos[6], Datos[7], Datos[8], Datos[9], Datos[10], Datos[11], Datos[12], Datos[13], Datos[14]);
        }
