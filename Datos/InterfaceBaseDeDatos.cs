...
namespace Datos
{
    public partial class InterfaceBaseDeDatos
    {
        ...
        {
            string[] Parametros = { "@Cedula", "@RFC", "@Nombre", "@Direccion", "@NumeroExterior", "@Pais", "@Estado", "@Municipio", "@Ciudad", "@Colonia", "@CodigoPostal", "@Telefono" };
            return Ejecutar("procRegistrarDentista", Parametros, Datos[0], Datos[1], Datos[2], Datos[3], Datos[4], Datos[5], Datos[6], Datos[7], Datos[8], Datos[9], Datos[10], Datos[11]);
        }
        ...
        {
            string[] Parametros = { "@Pedido", "@Dentista", "@Estatus", "@FechaIngreso", "@FechaCalculada", "@FechaEntrega", "@Urgencia", "@Fabricante", "@Total" };
            return Ejecutar("procGenerarPedido", Parametros, Datos[0], Datos[1], Datos[2], Datos[3], Datos[4], Datos[5], Datos[6], Datos[7], Datos[8]);
        }
        ...
        public int ActualizarDentista(string[] Datos)
        {
            string[] Parametros = { "@Cedula", "@RFC", "@Nombre", "@Direccion", "@NumeroExterior", "@Pais",
                "@Estado", "@Municipio", "@Ciudad", "@Colonia", "@CodigoPostal", "@Telefono", "@CedulaVieja" };
        ...
        {
            string[] Parametros = { "@Dentista", "@Estatus" };
            return Ejecutar("procCrearPedido", Parametros, Datos[0], Datos[1]);
        }

        public int InsertarProducto(string[] Datos)
        {
            string[] Parametros = { "@Pedido", "@Producto", "@Material", "@Precio", "@Cantidad", "@SubTotal" };
            return Ejecutar("procInsertarProducto", Parametros, Datos[0], Datos[1], Datos[2], Datos[3], Datos[4], Datos[5]);
        }
        ...
        {
            string[] Parametros = { "@Pedido", "@Codigo", "@Material", "@Cantidad", "@Precio", "@SubTotal" };
            return Ejecutar("procSacarProducto", Parametros, Datos[0], Datos[1], Datos[2], Datos[3], Datos[4], Datos[5]);
        }
